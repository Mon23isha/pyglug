...
def main_window():
    ...
    win.config(bg="Pink")
    win.title("Ws cube Tech")

    label1 = Label(win, text="Incorrect Spelling", font=("Time New Roman", 25, "bold"), bg="Pink", fg="white")
    ...
    label2 = Label(win, text="Correct Spelling", font=("Time New Roman", 25, "bold"), bg="Pink", fg="white")
